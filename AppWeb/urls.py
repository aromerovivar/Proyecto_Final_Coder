...
urlpatterns = [
    ...
    path('pages/list/', listablogs.as_view(),name="BlogLeer"),
    path('pages/<int:pk>/', detailblogs.as_view(),name="BlogDetalle"),
    path('pages/editar/<int:pk>', actualizarBlog.as_view(),name="Blogeditar"),
    path('pages/eliminar/<int:pk>', borrarBlog.as_view(),name="eliminarBlog"),
    ...
    path('accounts/eliminar/<int:pk>', borraruser.as_view(),name="eliminarUser")
]
